        ...
        itemBuilder: (context, index) {
          ...
          return GameCard(
            ...
            onTap: () {
              ...
              switch (juego['nombre']) {
                case 'Mobile Legends':
                  Navigator.push(context, MaterialPageRoute(builder: (_) => const MlbbCommunityPage()));
                  break;
                case 'League of Legends':
                  Navigator.push(context, MaterialPageRoute(builder: (_) => const LolCommunityPage()));
                  break;
                case 'Valorant':
                  Navigator.push(context, MaterialPageRoute(builder: (_) => const ValorantCommunityPage()));
                  break;
                case 'Wild Rift':
                  Navigator.push(context, MaterialPageRoute(builder: (_) => const WildCommunityPage()));
                  break;
                case 'Honkai':
                  Navigator.push(context, MaterialPageRoute(builder: (_) => const HonkaiCommunityPage()));
                  break;
              }
            },
          );
