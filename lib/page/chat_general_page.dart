                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: const Icon(Icons.auto_awesome, color: Colors.black54),
                    ),
                  ),
                ],
              ),
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          leading: CircleAvatar(
            radius: 24,
            backgroundColor:
            chat.isCommunity ? start : Colors.grey.shade300,
            child: Text(chat.name[0], style: const TextStyle(color: Colors.black87)),
          ),
          title: Text(
            chat.name,
          ...
          trailing: Column(
            ...
            children: [
              Text(chat.time,
                  style: TextStyle(color: Colors.black54.withOpacity(0.6), fontSize: 12)),
