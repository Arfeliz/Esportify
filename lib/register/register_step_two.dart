  ...
  Future<void> _seleccionarFechaTorneo(BuildContext context) async {
    ...
    if (picked != null) {
      setState(() {
        ...
        _fechaTorneoController.text = '$mm/${picked.year}';
      });
    }
  }
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const RegisterStepThree()),
                    );
                  },
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                          perteneceEquipo ? Colors.black : Colors.grey[300],
                          shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(8)),
                        ),
                        child: Text('Sí',
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: () => setState(() => perteneceEquipo = false),
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                          !perteneceEquipo ? Colors.black : Colors.grey[300],
                          shape: RoundedRectangleBorder(
